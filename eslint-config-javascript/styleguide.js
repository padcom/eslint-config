 ...
 * This is how the most complex function looks like
 *
 * This also shows that params need to have a type, since it is not TypeScript..
 *
 * @param {number} numberOfLoops number of loops to perform
 */
function whileLoops(numberOfLoops) {
